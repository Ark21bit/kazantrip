<template>
    <div class="rounded-5 overflow-hidden shadow-base">
        <div class="h-62.25 lg:h-70.25 [&>img]:(w-full h-full object-cover object-center)" v-html="media_avatar ?? `<img src='/imgs/avatar.svg' style='padding:20px 20px 0;object-fit:contain' alt=''>`">
        </div>
