<template>
    <Modal size="lg">
        ...
        <h3 class="mt-7.5 lg:mt-5 text-center font-Montserrat font-bold leading-1.2 sm:leading-1.2 text-5.5 sm:text-6.5 text-diamondBlack">{{ generalConfig?.static_info?.global_words?.thank_you }}</h3>
