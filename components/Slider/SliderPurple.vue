<template>
    <Swiper class="w-full flex flex-col lg:flex-row relative contain-layout overflow-visible" v-bind="options">
        <SwiperSlide class="flex flex-col">
            ...
            <div class="lg:mt-7.5 flex flex-col gap-5 p-5 lg:pr-22 lg:p-6 last:mr-0 mr-5 lg:bg-[url(/imgs/pattern.svg)] bg-[position:top_0_right_24px] grow bg-repeat-y shadow-base rounded-2xl ring-(1 inset #F6F6F6)">
                ...
                <Button class="w-full lg:w-41 mt-auto" size="sm">Заказать</Button>
            </div>
        </SwiperSlide>
        <SwiperSlide class="flex flex-col">
            ...
            <div class="lg:mt-7.5 flex flex-col gap-5 p-5 lg:pr-22 lg:p-6 last:mr-0 mr-5 lg:bg-[url(/imgs/pattern.svg)] bg-[position:top_0_right_24px] grow bg-repeat-y shadow-base rounded-2xl ring-(1 inset #F6F6F6)">
                ...
                <p class="text-sm lg:text-base text-second leading-1.4 lg:leading-1.4 [&>a]:text-primary">По вопросам организации многодневного тура, включающего экскурсию "ТЁПЛАЯ обзорная по Казани с посещением Казанского Кремля" обращайтесь по телефону <a href="tel:+7 927 487 03 00">+7 927 487 03 00</a> и электронной почте
