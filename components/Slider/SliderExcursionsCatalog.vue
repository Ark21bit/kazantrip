<template>
    <Swiper class="w-full flex flex-col gap-5 lg:flex-row relative" v-bind="options">
        ...
        <div class="flex gap-3 justify-between lg:absolute left-1/2 pointer-events-none lg:top-1/2 lg:-translate-1/2 w-full">
