<template>
    <div class="flex flex-col rounded-5 lg:rounded-3 3xl:rounded-5 overflow-hidden border border-#EBEBEB lg:border-transparent shadow-base">
        ...
        <div>
            <template v-if="info">
                <div v-for="item in isShort ? infoShorts : info" class="flex flex-col gap-2 lg:gap-1 3xl:gap-2 py-4.5 lg:py-2 3xl:py-4.5 p-5 lg:p-3 3xl:p-5 first:border-none border-t border-#EBEBEB text-sm lg:text-base font-semibold leading-1.2 lg:leading-1.2">
