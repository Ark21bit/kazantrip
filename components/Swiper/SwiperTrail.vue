<template>
    <Swiper class="w-full flex relative" :options="options">
        <swiper-slide class="w-full h-full shrink-0 [&>img]:(w-full h-full object-cover object-center) lg:w-[calc(25%-10px)] mr-5 last:mr-0 group/swiperTrail" v-for="n in 10">
            ...
            <div class="relative mt-6 lg:mt-7 flex flex-col gap-5 shadow-base ring-(1 inset #F6F6F6) p-5 text-diamondBlack rounded-5 bg-white">
