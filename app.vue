<template>
    ...
    <Transition enter-from-class="opacity-0" leave-to-class="opacity-0" enter-active-class="transition-opacity duration-300 ease-in-out" leave-active-class="transition-opacity duration-300 ease-in">
        <button v-show="scrollToUpButtonVisible" @click="scrollToUp" class="fixed top-1/2 -translate-y-1/2 right-[--width-content-margin] z-30 text-white flex items-center gap-2.5 text-sm leading-1.25 max-lg:hidden group-[.modal-open]/body:pr-4.25 group-[.modal-open.modal-open-mobile]/body:pr-0">
