<template>
    ...
    <div class="fixed z-30 right-[var(--width-content-margin)] bottom-7.5 leading-none items-end flex flex-col gap-2 text-white group-[.modal-open]/body:pr-4.25 group-[.modal-open.modal-open-mobile]/body:pr-0">
        <CustomLink target="_blank" to="/test" class="p-2.5 bg-#2AABEE transition-colors duration-500 ease-linear rounded-lg">
            <Icon size="24" name="Tg"></Icon>
        </CustomLink>
        <CustomLink target="_blank" to="/test" class="p-2.75 bg-#60D669 transition-colors duration-500 ease-linear rounded-lg">
